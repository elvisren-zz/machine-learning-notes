...
\newcommand\probability[1]{\mathop{\bf P\/}\left\{#1\right\}}
\newcommand\expect[1]{\mathop{\bf E\/} \left[ #1 \right]}
\newcommand\variance[1]{\mathop{\bf Var\/}\left[ #1 \right]}
\newcommand\covariance[2]{\mathop{\bf Cov\/}\left(#1,#2 \right)}
